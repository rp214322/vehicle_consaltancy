                                                        ...
                                                        <div class="select-list">
                                                            ...
                                                            <div class="select-list-item">
                                                                ...
                                                                <select id="BrandId" name="brand_id">
                                                                    ...
                                                                    @if(old('category_id'))
                                                                        @foreach (App\Models\Brand::where('category_id', old('category_id'))->pluck('name', 'id') as $id => $name)
                                                            ...
                                                            <div class="select-list-item">
                                                                ...
                                                                <select id="ModelId" name="model_id">
                                                                    ...
                                                                    @if(old('brand_id'))
                                                                        @foreach (App\Models\VehicalModel::where('brand_id', old('brand_id'))->pluck('name', 'id') as $id => $name)
                                                                            <option value="{{ $id }}" {{ old('model_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                            </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="cta__item set-bg" data-setbg="{{ asset('images/cta-1.jpg') }}">
                  ...
                  <div class="col-lg-6 col-md-6">
                    <div class="cta__item set-bg" data-setbg="{{ asset('images/cta-2.jpg') }}">
            ...
            if (categoryId) {
                $.ajax({
                    ...
                    success: function(response) {
                        console.log("Brand Response: ", response); // Debugging
                        $('#BrandId').html(response).prop('disabled', false);

                        // Check if niceSelect() is applied
                        if ($.fn.niceSelect) {
                            $('#BrandId').niceSelect('destroy');
                            $('#BrandId').niceSelect();
                        }
                    },
                    error: function() {
        ...
        $('#BrandId').on('change', function() {
            ...
            if (brandId) {
                $.ajax({
                    ...
                    success: function(response) {
                        console.log("Model Response: ", response); // Debugging
                        $('#ModelId').html(response).prop('disabled', false);

                        if ($.fn.niceSelect) {
                            $('#ModelId').niceSelect('destroy');
                            $('#ModelId').niceSelect();
                        }
                    },
                    error: function() {
