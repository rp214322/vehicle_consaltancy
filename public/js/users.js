...
jQuery(function () {
    ...
    $(document).ready(function () {
        ...
        initializeCountryState(); // Ensure dropdowns are populated when the modal is shown
    });
    ...
    function initializeCountryState() {
        ...
        // Fetch and populate countries (only Canada & India)
        fetch("https://restcountries.com/v3.1/all")
            ...
            .then((data) => {
                ...
                // Filter for Canada & India
                const filteredCountries = data.filter(
                    (country) => country.cca2 === "CA" || country.cca2 === "IN"
                );
                ...
                countrySelect.trigger("change"); // Refresh Select2
            })
